...
public class ModSounds {
    ...
    public static final ForgeSoundType BONGOAT_BLOCK_SOUNDS = new ForgeSoundType(1f, 1.23f, BONGOAT_BREAK, BONGOAT_STEP,
            BONGOAT_PLACE, BONGOAT_HIT, BONGOAT_FALL);

    private static RegistryObject<SoundEvent> registerSoundEvents(String name) {
        return SOUND_EVENTS.register(name,
                () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(BongoatMod.MODID, name)));
    }
